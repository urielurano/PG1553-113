...
#### points given that everything is in log scale ####
######################################################
######################################################
        ...
        try:
            ...
            if rfile:
                ...
                for line in rfile:
                    ...
                    x1.append(pow(10,(a-14.38)))
                    y1.append(pow(10,b))

                    if c != 0.0001: 
                        xizq.append(pow(10,c))
                    else:
                        xizq.append(0.00000001)

                    if d != 0.0001:
                        xder.append(pow(10,d))
                    else:
                        xder.append(0.00000001)
                        
                    if e != 0:
                        yarr.append(pow(10,e))
                    else:
                        yarr.append(0.0)

                    if f != 0:
                        yaba.append(pow(10,f))
                    else:
                        yaba.append(0.0)
...
filesArray = [ 'rxtasmavg', 'swiftbatavg', 'kvaminmax', 'ebl', 'lat', 'MAGIC', 'ned', 'suzaku', 'swiftuvot', 'swiftxrthi', 'swiftxrtmed']
