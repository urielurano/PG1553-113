        ...
        try:
            ...
            if rfile:
                ...
                for line in rfile:
                    ...
                    if c != 0: 
                        xizq.append(pow(10,a-c))
                    else:
                        xizq.append(0.0)

                    if d != 0:
                        xder.append(pow(10,a-d))
                    else:
                        xder.append(0.0)
                        
                    if e != 0:
                        yarr.append(pow(10,b-e))
                    else:
                        yarr.append(0.0)

                    if f != 0:
                        yaba.append(pow(10,b-f))
                    else:
                        yaba.append(0.0)
...
filesArray = ['swiftxrthi','MAGIC','swiftbatavg','ebl','ned','swiftuvot','kvaminmax', 'swiftxrthi',
              'lat','rxtasmavg','suzaku','swiftxrtmed']
